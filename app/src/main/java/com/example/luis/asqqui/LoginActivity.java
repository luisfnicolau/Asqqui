...
//    private UserLoginTask mAuthTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView forgotPasswordButton = (TextView) findViewById(R.id.login_forgot_password_button);
        String forgotPasswordString = "<u>" + forgotPasswordButton.getText() + "</u>";
        forgotPasswordButton.setText(Html.fromHtml(forgotPasswordString));
...
//                null,
//                null,
//                new String[]{DatabaseContract.UserEntry.COLUMN_EMAIL},
//
